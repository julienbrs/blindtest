                  ...
                  ;((n.state = !0),
                    wo(
                      ...
                      function (y, E) {
                        ...
                        if (E)
                          if (h.opaque)
                            (i.splice(H, v - H, y, 'overlay ' + E), (v = H + 2))
                          else
                            for (; H < v; H += 2) {
                              var Q = i[H + 1]
                              i[H + 1] = (Q ? Q + ' ' : '') + 'overlay ' + E
              ...
              y.empty() &&
                (n && n > 0
                  ...
                  : e.state.overwrite && !a
                    ? (H = D(
                        H.line,
                        Math.min(ge(o, H.line).text.length, H.ch + xe(s).length)
                      ))
                    : a &&
                      Ut &&
                      Ut.lineWise &&
      ...
      (function (At, Ot) {
        ;(function (C) {
          ...
          ;(C.defineMode('javascript', function (De, P) {
            ...
            function m(f, g) {
              if (g)
                if (g.block) {
                  ...
                  return S(f, g.vars) ? g : new z(g.prev, new ne(f, g.vars), !1)
              else return null
            }
            function x(f) {
              return (
            ...
            function et(f) {
              if (f == '}')
                return ((M.marked = 'string-2'), (M.state.tokenize = ce), d(Ue))
            }
            function xe(f) {
            ...
            function Ye(f) {
              if (f == '}')
                return ((M.marked = 'string-2'), (M.state.tokenize = ce), d(dt))
            }
            function Ze(f, g) {
        ...
        ;(function (C) {
          ...
          function Fe(m, x) {
            ...
            ;(ne(x.keywords),
              ...
              ne(x.atoms),
              z.length &&
                ((x.helperType = m[0]), C.registerHelper('hintWords', m[0], z)))
        ...
        ;(function (C) {
          ...
          ;(C.defineMode(
            ...
            function (De, P) {
              ...
              ;(P.highlightFormatting === void 0 &&
                (P.highlightFormatting = !1),
                  ...
                  for (var te = 0; te < p.formatting.length; te++)
                    (c.push(b.formatting + '-' + p.formatting[te]),
                      p.formatting[te] === 'header' &&
                        c.push(
                          b.formatting + '-' + p.formatting[te] + '-' + p.header
                        ),
