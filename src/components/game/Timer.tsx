...
export function Timer({
  ...
  return (
    <div className="flex flex-col items-center gap-2 landscape:gap-1 sm:gap-4">
      {/* Cercle de progression - Responsive size, smaller in landscape */}
      <motion.div
        className="relative h-24 w-24 landscape:h-20 landscape:w-20 sm:h-28 sm:w-28 md:h-32 md:w-32 landscape:md:h-24 landscape:md:w-24"
        animate={
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 flex items-center justify-center text-3xl font-bold landscape:text-2xl sm:text-4xl md:text-5xl landscape:md:text-3xl"
          animate={
            prefersReducedMotion
              ? { color: progressColor }
              : isCritical
      ...
      <motion.p
        className="text-sm font-medium landscape:text-xs sm:text-base md:text-lg"
        animate={{
          color: isCritical
            ? '#ef4444' // red-500
            : isWarning
